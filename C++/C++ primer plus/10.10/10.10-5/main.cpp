    ...
    while (cin >> ch && ch != 'Q')
    {
        ...
        case 'a':
            ...
            else
            {
                ...
                (cin >> value.fullname).get();
                (cin >> value.payment).get();
                object.push(value);
                cout << "You've successfully push the \"" << value.payment << "\"\n";
            }
        ...
        case 'b':
            if (object.pop(value))
                cout << "You've successfully pop the \"" << value.payment << "\"\n";
            else
